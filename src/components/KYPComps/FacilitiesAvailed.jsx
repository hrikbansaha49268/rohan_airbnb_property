...
const FacilitiesAvailed = () => {
    return (
        <section id='facilities' className='font-inter flex flex-col items-center container gap-y-9'>
            <ol className='flex flex-col gap-y-8'>
                <h3 className='font-medium text-3xl border-b w-fit px-12 pb-2 self-start'>Facilities Available</h3>
...
export default FacilitiesAvailed;